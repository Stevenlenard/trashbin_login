...
if ($users === null) {
    die('Token not found. Please request a new password reset link.');
}

if (strtotime($users['reset_token_expires_at']) <= time()) {
    die('Reset token has expired. Please request a new password reset link.');
}
?>
...
<head>
  ...
  <title>Smart Trashbin - Reset Password</title>
      ...
      <div class="forgot-content">
        ...
        <form method="post" action="process-reset-password.php">
          ...
          <div class="form-group">
            ...
            <small class="password-hint">At least 8 characters, 1 letter, and 1 number</small>
          ...
          <button type="submit" class="btn-primary" id="submitBtn">
            <i class="fas fa-check me-2"></i> <span id="btnText">Reset Password</span>
          </button>
